...
CORRECT_ANSWERS = %w(2 1 2 1 1 2 6 3 1,3,4 3,4 6 6)

RESULT = {
  0..2   => 'С логикой у вас очень слабо',
  3..6   => 'Логика не отсутствует, но, наверное, имеет смысл ее потренировать.',
  7..10  => 'Вполне приемлемый, говорящий о нормально развитых логических способностях',
  11..12 => 'Ваши логические способности хорошо развиты. Вас трудно убедить речами, в которых есть ' \
